...
|---|---|
| documents | **107,147** |
| 라벨 보유 | **84,479** (v3 프롬프트) |
| 수집 구간 | 2025-07-29 ~ 2026-08-23 |
| 매체 등급 미분류 | 17.0% |
| 중복·도배 강등 | 14,636 |
| DB | 131.3 MB (서빙 스냅샷 6.2 MB) |

출처: 구글뉴스 68,126 / 종토방 25,900 / 네이버뉴스 8,058 / 검색API 3,987 /
카페 941 / 4chan 135
...
| 채널 | 긍정 | 중립 | 부정 | 무관 | 중립비율 |
|---|---:|---:|---:|---:|---:|
| news | 14,943 | 32,654 | 12,720 | 27,623 | 54.1% |
...
- **005930은 13일치뿐**(2026-07-07 ~ 07-20, 채점률 12.7%) — 백필 대상. 그때까지
  화면에서 `채점 미완`으로 표시된다.
